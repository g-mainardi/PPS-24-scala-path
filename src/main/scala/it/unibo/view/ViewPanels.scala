...
import scala.swing.{Button, ButtonGroup, Component, Dimension, FlowPanel, Label, Orientation, RadioButton, Slider}

object ViewPanels:
  object ControlPanel:
    def apply(): ControlPanel = new ControlPanel()
  ...
  object ScenarioSettingsPanel:
    def apply(controller: DisplayableController): ScenarioSettingsPanel =
    new ScenarioSettingsPanel(controller)
